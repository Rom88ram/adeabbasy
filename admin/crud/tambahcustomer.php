    ...
    <div class="content">
        ...
        <div class="container kontener">
            <div class="row pb-4 isi">
                <div class="column" style="margin: 15px 15px; width: 70%;"><h2>Tambah Pelanggan</h2></div>
                ...
                <form action="" method="post" enctype="multipart/form-data">
                    ...
                    <div class="mb-3" style="margin-left: 20px; width: 55%;">
                        ...
                        <textarea class="form-control" id="alamatcust" name="alamatcust" rows="3"></textarea>
                    </div>
                    <div class="mb-3" style="margin-left: 20px; width: 55%;">
                        <label for="hpcust" class="form-label">No. HP</label>
                        <input type="text" class="form-control" id="hpcust" name="hpcust" required>
                    </div>
                    <div class="mb-3" style="margin-left: 20px; width: 55%;">
                        <label for="emailcust" class="form-label">Email</label>
                        <input type="text" class="form-control" id="emailcust" name="emailcust" required>
                    </div>
                    <div class="mb-3" style="margin-left: 20px; width: 55%;">

    ...
    <div class="content">
        ...
        <div class="container kontener">
            <div class="row pb-4 isi">
                <div class="column" style="margin: 15px 15px; width: 70%;"><h2>Tambah Paket Layanan</h2></div>
                ...
                <form action="" method="post" enctype="multipart/form-data">
                    <div class="mb-3" style="margin-left: 20px; width: 55%;">
                        ...
                        <input type="text" class="form-control" id="namapkt" name="namapkt" required>
                    </div>
                    <div class="mb-3" style="margin-left: 20px; width: 55%;">
                        <label for="hargapkt" class="form-label">Harga Paket</label>
                        <input type="number" class="form-control" id="hargapkt" name="hargapkt" required>
                    </div>
                    <div class="mb-3" style="margin-left: 20px; width: 55%;">
                        <label for="deskripsipkt" class="form-label">Deskripsi Paket</label>
                        <textarea class="form-control" id="deskripsipkt" name="deskripsipkt" rows="3"></textarea>
                    </div>
                    <div class="mb-3" style="margin-left: 20px; width: 55%;">

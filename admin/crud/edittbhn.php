<?php
    ...
    $tbh = query ("SELECT * FROM tambahan WHERE idtambahan = $idtambahan")[0];
    $jmlpaket = 0;
    $jmltambahan = 0;
    ...
    <div class="content">
        ...
        <div class="container kontener">
            <div class="row pb-4 isi">
                <div class="column" style="margin: 15px 15px; width: 70%;"><h2>Edit Tambahan Paket</h2></div>
                <h5 style="margin-left: 20px; width: 50%;">Silahkan Isi Data</h5>
                <form action="" method="post" enctype="multipart/form-data">
                    <input type="hidden" name="idtambahan" value="<?= $tbh['idtambahan']; ?>">
                    <div class="mb-3" style="margin-left: 20px; width: 55%;">
                        <label for="namatbhn" class="form-label">Nama Tambahan</label>
                        <input type="text" class="form-control" id="namatbhn" name="namatbhn" required value="<?= $tbh['nama_tambahan']; ?>">
                    </div>
                    <div class="mb-3" style="margin-left: 20px; width: 55%;">
                        <label for="hargatbhn" class="form-label">Harga Tambahan</label>
                        <input type="number" class="form-control" id="hargatbhn" name="hargatbhn" required value="<?= $tbh['harga_tambahan']; ?>">
                    </div>
                    <div class="mb-3" style="margin-left: 20px; width: 55%;">
                        <label for="deskripsitbhn" class="form-label">Deskripsi Tambahan</label>
                        <textarea class="form-control" id="deskripsitbhn" name="deskripsitbhn" rows="3" value="<?= $tbh['deskripsi_tambahan']; ?>"></textarea>
                    </div>
